...
console.log(tyrannoObj.weight);

// What was the diet of a velociraptor?
console.log(velociObj.diet);

// How long was a stegosaurus?
console.log(stegoObj.length);

// What time period did tyrannosaurus live in?
console.log(tyrannoObj.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tyrannoObj.roar = function() {
  return "RAWERSRARARWERSARARARRRR!"};
console.log(tyrannoObj.roar());
...
const uni = graduates.filter( a => (a.university.indexOf("Uni") != -1)).map( a => a.university);
console.log(uni);
...
*/
const animalNames = zooAnimals.map( a => `Name: ${a.animal_name}, Scientific: ${a.scientific_name}.`);
